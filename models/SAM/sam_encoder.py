...
from models.SAM.common import LayerNorm2d, MLPBlock
...
#     image_encoder = ImageEncoderViT(img_size = 224)
...
#
#         # Convert the shape from (B, H, W, 3) to (B, 3, H, W)
#         images = images.permute(0, 3, 1, 2)
#
#         image_embeddings = image_encoder(images) # ([B, 256, 14, 14])
