...
from models.MAE.mae_mask import MAEMaskDecoder
...
def train():
    ...
    # SETTINGS
    project_name = 'CV-MAE-Mask-Seg-Vit_B_retrain'  # Set the project name
    num_epochs = 1000
    lr = 1e-4
    weight_decay = 1e-5
    train_batch_size = 64
    ...
    log_path = './logs/MAE_Mask_Seg_Vit_B_retrain/'
    ...
    mae_path = "logs/MAE_Base_original/best_model.pt"

    # -----------------------------------------------------------------
    model = MAEMaskDecoder(mae_model_path=mae_path, num_classes=3, num_mask_tokens=8)
